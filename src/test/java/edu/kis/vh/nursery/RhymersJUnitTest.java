...
public class RhymersJUnitTest {
    ...
    public void testCountInList() {
        ListCountingOutRhymer rhymer = new ListCountingOutRhymer();
        int testValue = 4;
        rhymer.countIn(testValue);
    ...
    public void testCountInArray() {
        ArrayCountingOutRhymer rhymer = new ArrayCountingOutRhymer();
        int testValue = 4;
        rhymer.countIn(testValue);
    ...
    public void testCallCheckList() {
        DefaultCountingOutRhymer rhymer = new ListCountingOutRhymer();
        boolean result = rhymer.callCheck();
        Assert.assertEquals(true, result);
    ...
    public void testCallCheckArray() {
        DefaultCountingOutRhymer rhymer = new ArrayCountingOutRhymer();
        boolean result = rhymer.callCheck();
        Assert.assertEquals(true, result);
